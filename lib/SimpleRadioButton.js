...
export default class RadioForm extends React.Component {
  ...
  static defaultProps = {
    ...
    initial: 0,
    buttonColor: '#006af5',
    selectedButtonColor: '#006af5',
    formHorizontal: false,
    labelHorizontal: true,
    animation: true,
    labelColor: '#4f5a65',
    selectedLabelColor: '#4f5a65',
    wrapStyle: {},
    disabled: false
  }
  ...
  _renderButton(obj, i, arr) {
    return (
      <RadioButton
        ...
        wrapStyle={i === arr.length - 1 ? Style.radioContainerWrapStyleNoBorder : Style.radioContainerWrapStyleWithBorder}
      />
    )
  }
...
export class RadioButtonInput extends React.Component {
  ...
  render () {
    ...
    var borderWidth = this.props.borderWidth || 1.5
